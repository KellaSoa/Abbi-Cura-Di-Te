<div class="banner-page pt-5 pb-5" style="background-image: url(<?php the_field('banner'); ?>)">
    ...
    <div class="container">
        <div class="row align-items-end pb-5">
            <div class="col-12 col-sm-9">
                ...
                <div class="btn-single-pg-aree my-5">
                    <a class="btn-scopri px-4 py-2 text-white" href="#nostro-progetto"><?php echo get_field("btn1"); ?></a>
                </div>
            </div>
