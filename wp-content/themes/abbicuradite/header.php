            ...
            <div class="collapse navbar-collapse text-white" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item ps-2 position-relative">
                        <a class="nav-link active login-link" aria-current="page" href="<?php if(is_user_logged_in())  echo site_url('/area-test'); else echo site_url('/login'); ?>">
            ...
            <div class="collapse navbar-collapse position-relative" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item  rounded-top position-relative"><!-- valita -->
                        ...
                        <a class="nav-link" href="<?php if(is_user_logged_in() && $dataTestUser){echo site_url('/area-test'); }elseif(is_user_logged_in() && !$dataTestUser){echo site_url('/valutazione/questionario');} else{echo site_url('/login'); } ?>" tabindex="-1" >valuta il rischio nel tuo lavoro
                        </a>
                    </li>
                </ul>
            </div>
