...
<div class="modal fade docModal" id="docModal<?php echo $titleArea; ?>" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    ?>
                    <div class="row">
                        <div class=" m-auto">
                            <div id="testCarousel<?php echo $titleArea; ?>" data-tax="<?php echo $titleArea; ?>" data-count="<?php echo count($images); ?>" class="carousel slide d-lg-block testCarousel" data-bs-touch="false" data-bs-interval="false" data-carousel="carousel<?php ?>">
